...
public class AppointmentController {
    ...
    ResponseEntity<AppointmentResponseDto> addService(
            @Valid @RequestBody AddAppointmentDto addAppointmentDto) throws MethodArgumentNotValidException {
    ...
    @PutMapping("/id/{id}")
    ResponseEntity<AppointmentResponseDto> updateAppointment(@PathVariable("id") Long id, @RequestParam("time") LocalDateTime time) {
